...
var FEED = [
{
  ...
  spec:'Canva-mastered photo build (dark bubbles ground) - Gabi, 2026-08-07. Shayne fix applied on the artwork: No Fillers. No Compromise. Note for review: the vial render shows the generic PEPTIDE 5 MG label; if Blake wants the BPC lead here too, swap it in Canva.'
},
{
...
},
{
  ...
  spec:'EDIT IN CANVA ONLY - changes to pack.js do not touch this one. After editing, ask the desktop session to pull the PNG from Canva. Both pending edits landed 2026-08-07: the cold-chain sentence is gone and the vial now carries the BPC157/TB500 label.'
}
];
