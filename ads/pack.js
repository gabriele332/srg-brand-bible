...
var FEED = [
{
  ...
  pain:'Filler-cut material is the category&rsquo;s reputation problem.',
  ...
  caption:"Real peptides. No fillers. No compromise.\n\nEvery Steadfast lot is independently tested and ships with its own certificate of analysis.\n\nsteadfastresearchgroup.com\n\nFor laboratory and research use only. Not for human consumption. Not a drug and not intended to diagnose, treat, cure, or prevent any disease.",
  socials:{ ig:"Real peptides.\n\nNo fillers.\n\nNo compromise.\n\nThis category has a reputation problem.\n\nUnlabeled vials.\n\nBorrowed certificates.\n\n\"Trust me\" as a spec sheet.\n\nWe went the other way.\n\nEvery lot TESTED by an independent lab.\n\nBefore it ships.\n\nEvery time.\n\nAnd the certificate of analysis?\n\nIt comes WITH your order.\n\nNot claims.\n\nDOCUMENTS.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", fb:"Filler-cut vials are this category's reputation problem.\n\nWe decided not to be part of it.\n\nEvery lot independently tested.\n\nEvery order ships with its certificate.\n\nClaims are easy. DOCUMENTS are not.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", tt:"No fillers.\n\nNo compromise.\n\nEvery lot TESTED. Every certificate PUBLISHED.\n\nFor research use only. Not for human consumption.", th:"Want to know if a supplier is real?\n\nAsk for the document.\n\nThen ask for the lab that signed it.\n\nThen ask who owns that lab.\n\nWe already answered all three.\n\nFor research use only. Not for human consumption.", x:"Claims are easy.\n\nDocuments are not.\n\nFor research use only. Not for human consumption.", li:"The research supply category has a documentation problem.\n\nPurity claims are printed on artwork instead of lab reports.\n\nSteadfast ships every lot with a batch-specific certificate of analysis from an independent laboratory.\n\nNot because it's required.\n\nBecause it should be.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", yt:"Most suppliers in this category ask for trust.\n\nWe decided to hand over paperwork instead.\n\nEvery lot is tested by an independent lab before it ships.\n\nEvery order carries its certificate of analysis.\n\nThat's the whole pitch.\n\nDocuments over claims.\n\nComment COA and we'll send you the link to the published lot reports.\n\nFor research use only. Not for human consumption." },
  fields:{ headline:'Real peptides.', desc:'No fillers. No compromise.', cta:'Shop now' },
  spec:'Modeled on the Enhanced ad: cream ground, giant headline, vial crossing the type. CANVA EDIT PENDING (Shayne, 2026-08-05): the artwork still reads &ldquo;No gray market. No compromise.&rdquo; — change it to &ldquo;No Fillers. No Compromise.&rdquo; in Canva, then have the desktop session pull the PNG. Captions here are already corrected.'
},
{
  ...
  socials:{ ig:"Uncompromising purity.\n\nTwo words.\n\nEveryone in this category uses them.\n\nAlmost nobody can back them up.\n\nHere's the difference:\n\nPurity is not a FONT CHOICE.\n\nIt's a MEASUREMENT.\n\nTaken by a lab we don't own.\n\nPrinted on a certificate you can open.\n\nShipped with every single lot.\n\nThat's what uncompromising actually means.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", fb:"\"Uncompromising purity\" is easy to write.\n\nProving it is the hard part.\n\nEvery Steadfast lot is verified by an independent laboratory.\n\nThe certificate of analysis ships with it.\n\nWords on the label. Numbers on the document.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", tt:"Purity isn't a font choice.\n\nIt's a MEASUREMENT.\n\nOurs ships with the certificate.\n\nFor research use only. Not for human consumption.", th:"Everyone claims purity.\n\nAsk for the number.\n\nAsk for the lab.\n\nAsk for the report.\n\nWe publish all three.\n\nFor research use only. Not for human consumption.", x:"Purity is a measurement.\n\nNot a marketing word.\n\nFor research use only. Not for human consumption.", li:"In research supply, \"purity\" appears on a lot of artwork and very few documents.\n\nEvery Steadfast lot is verified by an independent laboratory, and the batch certificate ships with the order.\n\nA claim you can check beats a claim you have to trust.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", yt:"\"Uncompromising purity.\"\n\nEvery supplier says it.\n\nSo we made it checkable.\n\nIndependent lab verification on every lot.\n\nCertificate of analysis with every order.\n\nIf the number isn't published, the word doesn't count.\n\nComment PURITY and we'll send the link to the lot reports.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"Research, sourced right.\n\nFast, secure shipping across the U.S.\n\nA certificate of analysis on EVERY lot.\n\nAnd right now?\n\n10% OFF sitewide.\n\nCode: STEADFAST10\n\nNo hoops.\n\nNo \"contact us for pricing.\"\n\nJust documented material at a published price.\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", fb:"10% off sitewide.\n\nCode: STEADFAST10\n\nEvery lot ships with its certificate of analysis.\n\nFast, secure U.S. shipping.\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", tt:"10% OFF sitewide.\n\nCode: STEADFAST10\n\nCOA on every lot.\n\nFor research use only. Not for human consumption.", th:"Documented material.\n\nPublished prices.\n\n10% off with STEADFAST10.\n\nThat's the whole post.\n\nFor research use only. Not for human consumption.", x:"10% off sitewide. Code STEADFAST10.\n\nCOA on every lot.\n\nFor research use only. Not for human consumption.", li:"Steadfast Research Group ships research compounds with batch-specific certificates of analysis and published pricing.\n\nNew customers take 10% off sitewide with code STEADFAST10.\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", yt:"Sourcing research material shouldn't feel like a gamble.\n\nEvery Steadfast lot ships with its certificate of analysis.\n\nPrices are published.\n\nShipping is fast and secure across the U.S.\n\nAnd your first order is 10% off with code STEADFAST10.\n\nComment CODE and we'll send you the link.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"Tirzepatide.\n\nStarting at $69.99.\n\nNo \"DM for pricing.\"\n\nNo mystery.\n\nThe price is ON the ad.\n\n10 mg. 20 mg. 30 mg.\n\nLyophilized research material.\n\nAnd the lot's certificate of analysis?\n\nINCLUDED.\n\nsteadfastresearchgroup.com/products/tirzepatide\n\nFor research use only. Not for human consumption.", fb:"Tirzepatide, starting at $69.99.\n\n10 mg, 20 mg and 30 mg vials.\n\nCertificate of analysis included with the lot.\n\nPublished price. Documented material.\n\nsteadfastresearchgroup.com/products/tirzepatide\n\nFor research use only. Not for human consumption.", tt:"Tirzepatide. From $69.99.\n\nCOA included.\n\nPrice is on the ad. On purpose.\n\nFor research use only. Not for human consumption.", th:"Most suppliers hide the price.\n\nWe put it in the headline.\n\nTirzepatide from $69.99.\n\nCOA included.\n\nFor research use only. Not for human consumption.", x:"Tirzepatide from $69.99.\n\nCOA included. Price published.\n\nFor research use only. Not for human consumption.", li:"Tirzepatide research material, from $69.99.\n\nThree strengths, lyophilized, with the lot's certificate of analysis included.\n\nPublished pricing, because procurement shouldn't require a negotiation.\n\nsteadfastresearchgroup.com/products/tirzepatide\n\nFor research use only. Not for human consumption.", yt:"The compound is the headline.\n\nThe price is the hook.\n\nTirzepatide from $69.99, in 10, 20 and 30 mg vials.\n\nLyophilized, documented, and shipped with the lot's certificate of analysis.\n\nNo hidden pricing. No DM games.\n\nComment PRICE and we'll send the product link.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"Where quality meets consistency.\n\nAnyone can have one good batch.\n\nThe hard part is the NEXT one.\n\nAnd the one after that.\n\nOur answer is boring on purpose:\n\nIndependent testing on EVERY lot.\n\nDocumentation with EVERY order.\n\nThe same standard.\n\nREPEATED.\n\nThat's not a slogan.\n\nThat's a system.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", fb:"One good batch is luck.\n\nEvery batch is a system.\n\nIndependent testing on every lot.\n\nBatch documentation on every order.\n\nQuality, repeated on purpose.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", tt:"One good batch is luck.\n\nEVERY batch is a system.\n\nCOA on every order.\n\nFor research use only. Not for human consumption.", th:"Quality isn't an event.\n\nIt's a repetition.\n\nTested. Documented. Shipped.\n\nAgain. And again. And again.\n\nFor research use only. Not for human consumption.", x:"One good batch is luck.\n\nEvery batch is a system.\n\nFor research use only. Not for human consumption.", li:"Consistency is the least glamorous quality metric and the most important one.\n\nSteadfast ships every order with batch documentation and tests every lot independently.\n\nThe same standard, applied every time.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", yt:"Anyone can produce one good batch.\n\nThe real test is whether the tenth one matches the first.\n\nThat's why every Steadfast lot is independently tested.\n\nAnd every order carries its batch documentation.\n\nQuality meets consistency.\n\nOn purpose.\n\nComment DOCS and we'll send the link to the published reports.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  proof:'Code STEADFAST10, 10% off.',
  cta:'steadfastresearchgroup.com',
  caption:"Premium reagents. Compromise-free.\n\nGet professional-grade research materials shipped directly to your lab.\n\n10% off sitewide — use code STEADFAST10.\n\nsteadfastresearchgroup.com\n\nFor laboratory and research use only. Not for human consumption. Not a drug and not intended to diagnose, treat, cure, or prevent any disease.",
  socials:{ ig:"Premium reagents.\n\nCompromise-free.\n\nProfessional-grade research materials.\n\nShipped DIRECTLY to your lab.\n\nSecurely packaged.\n\nTested by labs we DON'T own.\n\nBecause an in-house certificate is a self-portrait.\n\nAnd right now: 10% OFF sitewide.\n\nCode: STEADFAST10\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", fb:"Premium reagents. Compromise-free.\n\nProfessional-grade materials, securely packaged.\n\nTested by independent labs.\n\n10% off sitewide with code STEADFAST10.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", tt:"Premium reagents.\n\nCompromise-FREE.\n\n10% off with STEADFAST10.\n\nFor research use only. Not for human consumption.", th:"An in-house certificate is a self-portrait.\n\nOurs come from labs we don't own.\n\nThat's the difference.\n\nFor research use only. Not for human consumption.", x:"Premium reagents. Compromise-free.\n\nVerified by labs we don't own.\n\nFor research use only. Not for human consumption.", li:"Professional-grade research reagents, securely packaged.\n\nVerification comes from independent laboratories, because a certificate is only as strong as the lab that signed it.\n\n10% off sitewide with code STEADFAST10.\n\nsteadfastresearchgroup.com\n\nFor research use only. Not for human consumption.", yt:"Premium reagents, without the compromise.\n\nProfessional-grade materials, shipped directly to your lab.\n\nSecurely packaged.\n\nAnd verified by laboratories we don't own.\n\nBecause independence is what makes a certificate worth reading.\n\n10% off sitewide with code STEADFAST10.\n\nComment LAB and we'll send the link.\n\nFor research use only. Not for human consumption." },
  fields:{ headline:'Premium reagents. Compromise-free.', desc:'10% off sitewide — code STEADFAST10.', cta:'Shop now' },
  spec:'EDIT IN CANVA ONLY — changes to pack.js do not touch this one. TWO CANVA EDITS PENDING: (1) Shayne, 2026-08-05 — delete the &ldquo;Securely packaged in cold-chain ready vials&rdquo; sentence from the artwork; products are cold-stored at the warehouse, not shipped cold (captions here already corrected); (2) Blake — swap the generic PEPTIDE 5 MG label for the BPC label (srg-label-bb10.png). Then ask the desktop session to pull the PNG.'
}
];
...
var STORIES = [
{
  ...
  socials:{ ig:"The label says 10 mg.\n\nThe lab measured 10.23 mg.\n\nWe publish BOTH numbers.\n\nEven when the second one is lower.\n\nBecause a label is a CLAIM.\n\nAnd fill weight is a MEASUREMENT.\n\n98.767% purity. Janoshik #151664.\n\nAll lot reports: steadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", fb:"Label: 10 mg.\n\nMeasured: 10.23 mg.\n\nWe publish both, every lot.\n\nEven when the number isn't flattering.\n\nsteadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", tt:"Label says 10 mg.\n\nLab measured 10.23 mg.\n\nWe publish BOTH.\n\nFor research use only. Not for human consumption.", th:"A label is a claim.\n\nA measurement is a fact.\n\nWe publish the fact.\n\nEvery lot.\n\nFor research use only. Not for human consumption.", x:"Label: 10 mg. Measured: 10.23 mg.\n\nWe publish both.\n\nFor research use only. Not for human consumption.", li:"A label is a claim. Fill weight is a measurement.\n\nIndependent labs weigh the net content of every Steadfast lot, and we publish the result next to the label figure — whichever way it goes.\n\nsteadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", yt:"The label on this vial says 10 milligrams.\n\nThe independent lab measured 10.23.\n\nWe publish both numbers, on every lot.\n\nEven when the measured number is lower than the label.\n\nThat's the standard.\n\nComment REPORT and we'll send the lot reports link.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"Free reconstitution calculator.\n\nVial mg + solvent volume.\n\n= mg/mL for THAT vial.\n\nNo email.\n\nNo account.\n\nNo catch.\n\nBecause concentration math done in your head, late, is how a good lot gets wasted.\n\nBookmark it:\n\nsteadfastresearchgroup.com/tools/peptide-reconstitution-calculator\n\nFor research use only. Not for human consumption.", fb:"Free reconstitution calculator.\n\nVial mg + solvent volume = mg/mL.\n\nNo email. No account. Just the tool.\n\nsteadfastresearchgroup.com/tools/peptide-reconstitution-calculator\n\nFor research use only. Not for human consumption.", tt:"Free calculator.\n\nNo email. No account.\n\nJust the math.\n\nFor research use only. Not for human consumption.", th:"We built a calculator.\n\nIt's free.\n\nIt asks for nothing.\n\nBookmark it.\n\nFor research use only. Not for human consumption.", x:"Free reconstitution calculator.\n\nNo email. No account.\n\nFor research use only. Not for human consumption.", li:"Bad concentration math wastes good material.\n\nWe published a free reconstitution calculator — labeled mg plus solvent volume returns mg/mL for the vial.\n\nNo signup required.\n\nsteadfastresearchgroup.com/tools/peptide-reconstitution-calculator\n\nFor research use only. Not for human consumption.", yt:"Concentration math done in your head, late at night, is how a good lot gets wasted.\n\nSo we built a free calculator.\n\nVial milligrams plus solvent volume, and it returns the mg per mL.\n\nNo email. No account. Nothing asked in return.\n\nComment CALC and we'll send you the link.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"The whole shelf.\n\nWith the prices LEFT IN.\n\nFifteen SKUs.\n\nEach one ships with its own certificate of analysis.\n\nNo \"contact us for pricing.\"\n\nNo games.\n\nFree shipping over $200.\n\n10% off your first order: STEADFAST10\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", fb:"Fifteen SKUs. Prices published.\n\nEvery one ships with its certificate of analysis.\n\nFree shipping over $200.\n\nSTEADFAST10 for 10% off a first order.\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", tt:"The whole shelf.\n\nPrices LEFT IN.\n\nCOA on every SKU.\n\nFor research use only. Not for human consumption.", th:"\"Contact us for pricing\" is a red flag.\n\nHere's the whole shelf.\n\nPrices included.\n\nFor research use only. Not for human consumption.", x:"The whole lineup. Prices published.\n\nCOA on every SKU.\n\nFor research use only. Not for human consumption.", li:"Published pricing shouldn't be a differentiator, but in this category it is.\n\nFifteen SKUs, each with a batch-specific certificate of analysis.\n\nFree shipping over $200; STEADFAST10 takes 10% off a first order.\n\nsteadfastresearchgroup.com/products\n\nFor research use only. Not for human consumption.", yt:"In this category, most sellers hide their prices.\n\nWe put the whole shelf in one image, prices included.\n\nFifteen SKUs, each shipping with its own certificate of analysis.\n\nFree shipping over $200.\n\nAnd STEADFAST10 gets 10% off a first order.\n\nComment SHELF and we'll send the link.\n\nFor research use only. Not for human consumption." },
...
},
{
  ...
  socials:{ ig:"The full panel.\n\nNot one number.\n\nALL of them.\n\nPurity.\n\nIdentity.\n\nNet content.\n\nEvery number on the certificate.\n\nEvery certificate on the site.\n\nIf a supplier only shows you one number...\n\nAsk where the rest went.\n\nsteadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", fb:"One number is marketing.\n\nThe full panel is documentation.\n\nPurity, identity, net content — published for every lot.\n\nsteadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", tt:"One number is marketing.\n\nThe FULL panel is proof.\n\nFor research use only. Not for human consumption.", th:"Purity. Identity. Net content.\n\nThe full panel.\n\nPublished.\n\nEvery lot.\n\nFor research use only. Not for human consumption.", x:"One number is marketing.\n\nThe full panel is documentation.\n\nFor research use only. Not for human consumption.", li:"A single purity number tells part of the story.\n\nSteadfast publishes the full analytical panel — purity, identity and net content — for every lot, on the site.\n\nsteadfastresearchgroup.com/coa\n\nFor research use only. Not for human consumption.", yt:"Most suppliers show you one number.\n\nWe publish the whole panel.\n\nPurity. Identity. Net content.\n\nEvery number on the certificate, every certificate on the site.\n\nIf someone only shows you one number, ask where the rest went.\n\nComment PANEL and we'll send the reports link.\n\nFor research use only. Not for human consumption." },
